...
#include "k16/input.h"
#include "k16/uart.h"
typedef struct {k16_memory_t memory;k16_cpu_t cpu;k16_vpu_t vpu;k16_copper_t copper;k16_dma_t dma;k16_input_t input;k16_uart_t uart;uint64_t ticks;} k16_machine_t;
