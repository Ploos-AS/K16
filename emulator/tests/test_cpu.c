...
int main(void)
{
    ...
    rom[0x3fee]=0x00;rom[0x3fef]=0xcc;rom[0xc00]=0x40;k16_rom_load(&mem,rom,sizeof(rom));
    ...
    rom[0x3fea]=0x10;rom[0x3feb]=0xcc;rom[0xc10]=0x40;k16_rom_load(&mem,rom,sizeof(rom));
