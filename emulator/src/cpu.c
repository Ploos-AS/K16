...
uint32_t k16_cpu_step(k16_cpu_t *c,k16_memory_t *m)
{
    ...
    case 0x14:{uint32_t e=(uint16_t)(c->d+fetch8(c,m));if(c->p&K16_P_M){uint8_t a=(uint8_t)c->a,v=k16_read8(m,e);nz8(c,(uint8_t)(a&v));k16_write8(m,e,(uint8_t)(v&~a));return 5;}else{uint16_t a=c->a,v=read16(m,e);nz16(c,(uint16_t)(a&v));k16_write8(m,e,(uint8_t)(v&~a));k16_write8(m,e+1u,(uint8_t)((v&~a)>>8));return 7;}}
    case 0x1c:{uint16_t a=fetch16(c,m);uint32_t e=((uint32_t)c->dbr<<16)|a;if(c->p&K16_P_M){uint8_t av=(uint8_t)c->a,v=k16_read8(m,e);nz8(c,(uint8_t)(av&v));k16_write8(m,e,(uint8_t)(v&~av));return 6;}else{uint16_t av=c->a,v=read16(m,e);nz16(c,(uint16_t)(av&v));k16_write8(m,e,(uint8_t)(v&~av));k16_write8(m,e+1u,(uint8_t)((v&~av)>>8));return 8;}}
    case 0x04:{uint32_t e=(uint16_t)(c->d+fetch8(c,m));if(c->p&K16_P_M){uint8_t a=(uint8_t)c->a,v=k16_read8(m,e);nz8(c,(uint8_t)(a&v));k16_write8(m,e,(uint8_t)(v|a));return 5;}else{uint16_t a=c->a,v=read16(m,e),r=(uint16_t)(v|a);nz16(c,(uint16_t)(a&v));k16_write8(m,e,(uint8_t)r);k16_write8(m,e+1u,(uint8_t)(r>>8));return 7;}}
    case 0x0c:{uint16_t a=fetch16(c,m);uint32_t e=((uint32_t)c->dbr<<16)|a;if(c->p&K16_P_M){uint8_t av=(uint8_t)c->a,v=k16_read8(m,e);nz8(c,(uint8_t)(av&v));k16_write8(m,e,(uint8_t)(v|av));return 6;}else{uint16_t av=c->a,v=read16(m,e),r=(uint16_t)(v|av);nz16(c,(uint16_t)(av&v));k16_write8(m,e,(uint8_t)r);k16_write8(m,e+1u,(uint8_t)(r>>8));return 8;}}
