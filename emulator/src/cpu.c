...
uint32_t k16_cpu_step(k16_cpu_t *c,k16_memory_t *m)
{
    ...
    case 0x06:{uint32_t e=(uint16_t)(c->d+fetch8(c,m));if(c->p&K16_P_M){uint8_t v=k16_read8(m,e);c->p=(uint8_t)((c->p&~K16_P_C)|((v&0x80u)?K16_P_C:0));v=(uint8_t)(v<<1);k16_write8(m,e,v);nz8(c,v);return 5;}else{uint16_t v=read16(m,e);c->p=(uint8_t)((c->p&~K16_P_C)|((v&0x8000u)?K16_P_C:0));v=(uint16_t)(v<<1);k16_write8(m,e,(uint8_t)v);k16_write8(m,e+1u,(uint8_t)(v>>8));nz16(c,v);return 7;}} /* ASL dp */
    ...
    case 0x16:{uint32_t e=(uint16_t)(c->d+fetch8(c,m)+c->x);if(c->p&K16_P_M){uint8_t v=k16_read8(m,e);c->p=(uint8_t)((c->p&~K16_P_C)|((v&0x80u)?K16_P_C:0));v=(uint8_t)(v<<1);k16_write8(m,e,v);nz8(c,v);return 6;}else{uint16_t v=read16(m,e);c->p=(uint8_t)((c->p&~K16_P_C)|((v&0x8000u)?K16_P_C:0));v=(uint16_t)(v<<1);k16_write8(m,e,(uint8_t)v);k16_write8(m,e+1u,(uint8_t)(v>>8));nz16(c,v);return 8;}} /* ASL dp,X */
    ...
    case 0x46:{uint32_t e=(uint16_t)(c->d+fetch8(c,m));if(c->p&K16_P_M){uint8_t v=k16_read8(m,e);c->p=(uint8_t)((c->p&~K16_P_C)|((v&1u)?K16_P_C:0));v>>=1;k16_write8(m,e,v);nz8(c,v);return 5;}else{uint16_t v=read16(m,e);c->p=(uint8_t)((c->p&~K16_P_C)|((v&1u)?K16_P_C:0));v>>=1;k16_write8(m,e,(uint8_t)v);k16_write8(m,e+1u,(uint8_t)(v>>8));nz16(c,v);return 7;}} /* LSR dp */
    ...
    case 0x56:{uint32_t e=(uint16_t)(c->d+fetch8(c,m)+c->x);if(c->p&K16_P_M){uint8_t v=k16_read8(m,e);c->p=(uint8_t)((c->p&~K16_P_C)|((v&1u)?K16_P_C:0));v>>=1;k16_write8(m,e,v);nz8(c,v);return 6;}else{uint16_t v=read16(m,e);c->p=(uint8_t)((c->p&~K16_P_C)|((v&1u)?K16_P_C:0));v>>=1;k16_write8(m,e,(uint8_t)v);k16_write8(m,e+1u,(uint8_t)(v>>8));nz16(c,v);return 8;}} /* LSR dp,X */
    ...
    case 0x26:{uint32_t e=(uint16_t)(c->d+fetch8(c,m));if(c->p&K16_P_M){uint8_t v=k16_read8(m,e),ci=(c->p&K16_P_C)?1u:0u;c->p=(uint8_t)((c->p&~K16_P_C)|((v&0x80u)?K16_P_C:0));v=(uint8_t)((v<<1)|ci);k16_write8(m,e,v);nz8(c,v);return 5;}else{uint16_t v=read16(m,e);uint8_t ci=(c->p&K16_P_C)?1u:0u;c->p=(uint8_t)((c->p&~K16_P_C)|((v&0x8000u)?K16_P_C:0));v=(uint16_t)((v<<1)|ci);k16_write8(m,e,(uint8_t)v);k16_write8(m,e+1u,(uint8_t)(v>>8));nz16(c,v);return 7;}} /* ROL dp */
    ...
    case 0x66:{uint32_t e=(uint16_t)(c->d+fetch8(c,m));if(c->p&K16_P_M){uint8_t v=k16_read8(m,e),ci=(c->p&K16_P_C)?0x80u:0u;c->p=(uint8_t)((c->p&~K16_P_C)|((v&1u)?K16_P_C:0));v=(uint8_t)((v>>1)|ci);k16_write8(m,e,v);nz8(c,v);return 5;}else{uint16_t v=read16(m,e),ci=(c->p&K16_P_C)?0x8000u:0u;c->p=(uint8_t)((c->p&~K16_P_C)|((v&1u)?K16_P_C:0));v=(uint16_t)((v>>1)|ci);k16_write8(m,e,(uint8_t)v);k16_write8(m,e+1u,(uint8_t)(v>>8));nz16(c,v);return 7;}} /* ROR dp */
    ...
    case 0x76:{uint32_t e=(uint16_t)(c->d+fetch8(c,m)+c->x);if(c->p&K16_P_M){uint8_t v=k16_read8(m,e),ci=(c->p&K16_P_C)?0x80u:0u;c->p=(uint8_t)((c->p&~K16_P_C)|((v&1u)?K16_P_C:0));v=(uint8_t)((v>>1)|ci);k16_write8(m,e,v);nz8(c,v);return 6;}else{uint16_t v=read16(m,e),ci=(c->p&K16_P_C)?0x8000u:0u;c->p=(uint8_t)((c->p&~K16_P_C)|((v&1u)?K16_P_C:0));v=(uint16_t)((v>>1)|ci);k16_write8(m,e,(uint8_t)v);k16_write8(m,e+1u,(uint8_t)(v>>8));nz16(c,v);return 8;}} /* ROR dp,X */
    ...
    case 0xe6:{uint32_t e=(uint16_t)(c->d+fetch8(c,m));if(c->p&K16_P_M){uint8_t v=(uint8_t)(k16_read8(m,e)+1u);k16_write8(m,e,v);nz8(c,v);return 5;}else{uint16_t v=(uint16_t)(read16(m,e)+1u);k16_write8(m,e,(uint8_t)v);k16_write8(m,e+1u,(uint8_t)(v>>8));nz16(c,v);return 7;}} /* INC dp */
    case 0xf6:{uint32_t e=(uint16_t)(c->d+fetch8(c,m)+c->x);if(c->p&K16_P_M){uint8_t v=(uint8_t)(k16_read8(m,e)+1u);k16_write8(m,e,v);nz8(c,v);return 6;}else{uint16_t v=(uint16_t)(read16(m,e)+1u);k16_write8(m,e,(uint8_t)v);k16_write8(m,e+1u,(uint8_t)(v>>8));nz16(c,v);return 8;}} /* INC dp,X */
    ...
    case 0xc6:{uint32_t e=(uint16_t)(c->d+fetch8(c,m));if(c->p&K16_P_M){uint8_t v=(uint8_t)(k16_read8(m,e)-1u);k16_write8(m,e,v);nz8(c,v);return 5;}else{uint16_t v=(uint16_t)(read16(m,e)-1u);k16_write8(m,e,(uint8_t)v);k16_write8(m,e+1u,(uint8_t)(v>>8));nz16(c,v);return 7;}} /* DEC dp */
    case 0xd6:{uint32_t e=(uint16_t)(c->d+fetch8(c,m)+c->x);if(c->p&K16_P_M){uint8_t v=(uint8_t)(k16_read8(m,e)-1u);k16_write8(m,e,v);nz8(c,v);return 6;}else{uint16_t v=(uint16_t)(read16(m,e)-1u);k16_write8(m,e,(uint8_t)v);k16_write8(m,e+1u,(uint8_t)(v>>8));nz16(c,v);return 8;}} /* DEC dp,X */
    ...
    case 0x14:{uint32_t e=(uint16_t)(c->d+fetch8(c,m));if(c->p&K16_P_M){uint8_t a=(uint8_t)c->a,v=k16_read8(m,e);z8(c,(uint8_t)(a&v));k16_write8(m,e,(uint8_t)(v&~a));return 5;}else{uint16_t a=c->a,v=read16(m,e);z16(c,(uint16_t)(a&v));k16_write8(m,e,(uint8_t)(v&~a));k16_write8(m,e+1u,(uint8_t)((v&~a)>>8));return 7;}}
    ...
    case 0x04:{uint32_t e=(uint16_t)(c->d+fetch8(c,m));if(c->p&K16_P_M){uint8_t a=(uint8_t)c->a,v=k16_read8(m,e);z8(c,(uint8_t)(a&v));k16_write8(m,e,(uint8_t)(v|a));return 5;}else{uint16_t a=c->a,v=read16(m,e),r=(uint16_t)(v|a);z16(c,(uint16_t)(a&v));k16_write8(m,e,(uint8_t)r);k16_write8(m,e+1u,(uint8_t)(r>>8));return 7;}}
    ...
    case 0xa4:{uint32_t e=(uint16_t)(c->d+fetch8(c,m));if(c->p&K16_P_X){c->y=k16_read8(m,e);nz8(c,(uint8_t)c->y);return 3;}c->y=read16(m,e);nz16(c,c->y);return 4;} /* LDY dp */
    case 0xb4:{uint32_t e=(uint16_t)(c->d+fetch8(c,m)+c->x);if(c->p&K16_P_X){c->y=k16_read8(m,e);nz8(c,(uint8_t)c->y);return 4;}c->y=read16(m,e);nz16(c,c->y);return 5;} /* LDY dp,X */
    ...
    case 0xa6:{uint32_t e=(uint16_t)(c->d+fetch8(c,m));if(c->p&K16_P_X){c->x=k16_read8(m,e);nz8(c,(uint8_t)c->x);return 3;}c->x=read16(m,e);nz16(c,c->x);return 4;} /* LDX dp */
    case 0xb6:{uint32_t e=(uint16_t)(c->d+fetch8(c,m)+c->y);if(c->p&K16_P_X){c->x=k16_read8(m,e);nz8(c,(uint8_t)c->x);return 4;}c->x=read16(m,e);nz16(c,c->x);return 5;} /* LDX dp,Y */
    ...
    case 0xb5:{uint32_t e=(uint16_t)(c->d+fetch8(c,m)+c->x);if(c->p&K16_P_M){uint8_t v=k16_read8(m,e);c->a=(uint16_t)((c->a&0xff00u)|v);nz8(c,v);return 4;}c->a=read16(m,e);nz16(c,c->a);return 5;} /* LDA dp,X */
    ...
    case 0xc4:{uint32_t e=(uint16_t)(c->d+fetch8(c,m));if(c->p&K16_P_X){cmp8(c,(uint8_t)c->y,k16_read8(m,e));return 3;}cmp16(c,c->y,read16(m,e));return 4;} /* CPY dp */
