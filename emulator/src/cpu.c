...
uint32_t k16_cpu_step(k16_cpu_t *c,k16_memory_t *m)
{
    ...
    case 0x89:if(c->p&K16_P_M){uint8_t v=fetch8(c,m);nz8(c,(uint8_t)c->a&v);return 2;}else{uint16_t v=fetch16(c,m);nz16(c,c->a&v);return 3;} /* BIT # */
    case 0x24:{uint32_t e=(uint16_t)(c->d+fetch8(c,m));uint8_t v=k16_read8(m,e);c->p=(uint8_t)((c->p&~(K16_P_N|K16_P_V))|(v&0x80u)|((v&0x40u)?K16_P_V:0));if(c->p&K16_P_M)nz8(c,(uint8_t)c->a&v);else nz16(c,c->a&read16(m,e));return (c->p&K16_P_M)?3:4;}
    case 0x34:{uint32_t e=(uint16_t)(c->d+fetch8(c,m)+c->x);uint8_t v=k16_read8(m,e);c->p=(uint8_t)((c->p&~(K16_P_N|K16_P_V))|(v&0x80u)|((v&0x40u)?K16_P_V:0));if(c->p&K16_P_M)nz8(c,(uint8_t)c->a&v);else nz16(c,c->a&read16(m,e));return (c->p&K16_P_M)?4:5;}
    case 0x2c:{uint16_t a=fetch16(c,m);uint32_t e=((uint32_t)c->dbr<<16)|a;uint8_t v=k16_read8(m,e);c->p=(uint8_t)((c->p&~(K16_P_N|K16_P_V))|(v&0x80u)|((v&0x40u)?K16_P_V:0));if(c->p&K16_P_M)nz8(c,(uint8_t)c->a&v);else nz16(c,c->a&read16(m,e));return (c->p&K16_P_M)?4:5;}
    case 0x3c:{uint16_t a=(uint16_t)(fetch16(c,m)+c->x);uint32_t e=((uint32_t)c->dbr<<16)|a;uint8_t v=k16_read8(m,e);c->p=(uint8_t)((c->p&~(K16_P_N|K16_P_V))|(v&0x80u)|((v&0x40u)?K16_P_V:0));if(c->p&K16_P_M)nz8(c,(uint8_t)c->a&v);else nz16(c,c->a&read16(m,e));return (c->p&K16_P_M)?4:5;}
